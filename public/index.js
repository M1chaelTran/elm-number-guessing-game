...
var _user$project$BootstrapLayout$centerAlign = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$BootstrapLayout$inputStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'width', _1: '50px'},
		_1: {ctor: '[]'}
	});
var _user$project$BootstrapLayout$buttonPadding = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin', _1: '5px'},
		_1: {ctor: '[]'}
	});
var _user$project$BootstrapLayout$rowStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$BootstrapLayout$Model = F6(
	function (a, b, c, d, e, f) {
		return {minNumber: a, maxNumber: b, randomNumber: c, guessNumber: d, page: e, numberOfGames: f};
	});
var _user$project$BootstrapLayout$GameOver = {ctor: 'GameOver'};
var _user$project$BootstrapLayout$GameInProgress = {ctor: 'GameInProgress'};
var _user$project$BootstrapLayout$GameSetup = {ctor: 'GameSetup'};
var _user$project$BootstrapLayout$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	A6(_user$project$BootstrapLayout$Model, 1, 10, 0, 1, _user$project$BootstrapLayout$GameSetup, 1),
	{ctor: '[]'});
var _user$project$BootstrapLayout$Correct = {ctor: 'Correct'};
var _user$project$BootstrapLayout$MaxNumber = function (a) {
	return {ctor: 'MaxNumber', _0: a};
};
var _user$project$BootstrapLayout$MinNumber = function (a) {
	return {ctor: 'MinNumber', _0: a};
};
var _user$project$BootstrapLayout$NewGame = {ctor: 'NewGame'};
var _user$project$BootstrapLayout$gameOverView = function (model) {
	return A2(
			...
			_0: A2(
				_rundis$elm_bootstrap$Bootstrap_Grid$row,
				{
					...
					_0: _rundis$elm_bootstrap$Bootstrap_Grid_Row$attrs(
						{
							ctor: '::',
							_0: _user$project$BootstrapLayout$rowStyle,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Good game!'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(model.guessNumber),
											' turns'))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										_rundis$elm_bootstrap$Bootstrap_Button$button,
										{
											...
											_1: {
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$BootstrapLayout$NewGame),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Increase difficulty'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _user$project$BootstrapLayout$GoHigher = {ctor: 'GoHigher'};
var _user$project$BootstrapLayout$GoLower = {ctor: 'GoLower'};
var _user$project$BootstrapLayout$gameView = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('It is number'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(model.randomNumber),
												'?')),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Grid_Row$attrs(
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$BootstrapLayout$centerAlign,
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										_rundis$elm_bootstrap$Bootstrap_Button$button,
										{
											...
											_1: {
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
													{
														ctor: '::',
														_0: _user$project$BootstrapLayout$buttonPadding,
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_user$project$BootstrapLayout$GoLower),
															_1: {ctor: '[]'}
														}
													}),
												_1: {ctor: '[]'}
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Go lower'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
													...
													_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_user$project$BootstrapLayout$Correct),
																_1: {ctor: '[]'}
															}
														}),
													_1: {ctor: '[]'}
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Correct!'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
														...
														_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$BootstrapLayout$GoHigher),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {ctor: '[]'}
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Go higher'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$BootstrapLayout$Play = {ctor: 'Play'};
var _user$project$BootstrapLayout$setupView = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Think of a number between'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
								...
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
									{
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
											{
												ctor: '::',
												_0: _user$project$BootstrapLayout$inputStyle,
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(
														_elm_lang$core$Basics$toString(model.minNumber)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$BootstrapLayout$MinNumber),
														_1: {ctor: '[]'}
													}
												}
											}),
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value(
																_elm_lang$core$Basics$toString(model.maxNumber)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$BootstrapLayout$MaxNumber),
																_1: {ctor: '[]'}
															}
														}
													}),
										...
										_rundis$elm_bootstrap$Bootstrap_Button$button,
										{
											...
											_1: {
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$BootstrapLayout$Play),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
	...
	return A2(
		...
		},
		{
			...
			_0: function () {
				...
				switch (_p0.ctor) {
					case 'GameSetup':
						return _user$project$BootstrapLayout$setupView(model);
					case 'GameInProgress':
						return _user$project$BootstrapLayout$gameView(model);
					default:
						return _user$project$BootstrapLayout$gameOverView(model);
				}
			}(),
			_1: {ctor: '[]'}
		});
...
var _user$project$BootstrapLayout$RandomNumber = function (a) {
	return {ctor: 'RandomNumber', _0: a};
};
var _user$project$BootstrapLayout$generateRandomNumberBetween = F2(
	function (min, max) {
		return A2(
			_elm_lang$core$Random$generate,
			_user$project$BootstrapLayout$RandomNumber,
			A2(_elm_lang$core$Random$int, min, max));
	});
var _user$project$BootstrapLayout$endGame = F2(
	function (model, lower) {
		var guessNumber = model.guessNumber + 1;
		var maxNumber = lower ? A2(_elm_lang$core$Basics$max, model.minNumber, model.randomNumber - 1) : model.maxNumber;
		var minNumber = (!lower) ? A2(_elm_lang$core$Basics$min, model.maxNumber, model.randomNumber + 1) : model.minNumber;
		var page = _elm_lang$core$Native_Utils.eq(minNumber, maxNumber) ? _user$project$BootstrapLayout$GameOver : _user$project$BootstrapLayout$GameInProgress;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{minNumber: minNumber, maxNumber: maxNumber, guessNumber: guessNumber, page: page}),
			_1: A2(_user$project$BootstrapLayout$generateRandomNumberBetween, minNumber, maxNumber)
		};
	});
		...
		switch (_p1.ctor) {
			...
			case 'Play':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{page: _user$project$BootstrapLayout$GameInProgress}),
					_1: A2(_user$project$BootstrapLayout$generateRandomNumberBetween, model.minNumber, model.maxNumber)
				};
			case 'GoLower':
				return A2(_user$project$BootstrapLayout$endGame, model, true);
			case 'GoHigher':
				return A2(_user$project$BootstrapLayout$endGame, model, false);
			case 'NewGame':
				var gameCount = model.numberOfGames + 1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{page: _user$project$BootstrapLayout$GameSetup, minNumber: 1, maxNumber: 10 * gameCount, guessNumber: 1, numberOfGames: gameCount}),
					{ctor: '[]'});
			case 'MinNumber':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{page: _user$project$BootstrapLayout$GameOver}),
					{ctor: '[]'});
		}
	});
var _user$project$BootstrapLayout$main = _elm_lang$html$Html$program(
	{init: _user$project$BootstrapLayout$init, view: _user$project$BootstrapLayout$mainContent, update: _user$project$BootstrapLayout$update, subscriptions: _user$project$BootstrapLayout$subscriptions})();
